...
const translations = {
  en: {
    ...
    review: {
      ...
      positiveTitle: "That's Great! Thank You for Visiting!",
      positiveSubtext: 'Share your info below and we\'ll open Google so you can leave a quick review. As a thank-you, you\'ll get a discount code for your next visit!',
      positiveSubmitButton: 'Continue to Google Review',
      positiveDisclaimer: 'Your info helps us say thanks — we\'ll never spam you.',
      positiveSubmitted: 'You\'re Awesome — Thank You!',
      positiveSubmittedSubtext: 'Your Google Review page should be open in a new tab.',
      checkEmailTitle: 'Check Your Email for Your Discount Code!',
      checkEmailSubtext: 'We just sent your reward to the email you provided.',
  ...
  es: {
    ...
    review: {
      ...
      positiveTitle: '¡Qué Bueno! ¡Gracias por Visitarnos!',
      positiveSubtext: 'Comparte tu información abajo y te abriremos Google para que dejes una reseña rápida. ¡Como agradecimiento, te daremos un código de descuento para tu próxima visita!',
      positiveSubmitButton: 'Continuar a Reseña de Google',
      positiveDisclaimer: 'Tu información nos ayuda a agradecerte — nunca te enviaremos spam.',
      positiveSubmitted: '¡Eres Increíble — Gracias!',
      positiveSubmittedSubtext: 'Tu página de Reseña de Google debería estar abierta en una nueva pestaña.',
      checkEmailTitle: '¡Revisa Tu Correo para Tu Código de Descuento!',
      checkEmailSubtext: 'Acabamos de enviar tu recompensa al correo que nos diste.',
