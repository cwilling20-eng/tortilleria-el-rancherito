...
const translations = {
  en: {
    ...
    review: {
      ...
      positiveSubmittedSubtext: 'Your Google Review page should be open in a new tab. Here\'s your discount as a thank-you!',
  ...
  es: {
    ...
    review: {
      ...
      positiveSubmittedSubtext: 'Tu página de Reseña de Google debería estar abierta en una nueva pestaña. ¡Aquí está tu descuento como agradecimiento!',
