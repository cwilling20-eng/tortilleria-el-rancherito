...
const galleryImages = [
  { src: '/images/tamales.jpg', alt: 'Tamales hechos a mano envueltos en hojas de maíz en Tortilleria El Rancherito', span: 'row-span-2' },
  { src: '/images/barbacoa.jpg', alt: 'Barbacoa cocida a fuego lento servida con tortillas frescas', span: '' },
  { src: '/images/street-tacos.jpg', alt: 'Tacos auténticos con cilantro, cebolla y limón', span: '' },
  { src: '/images/breakfast tacos.jpg', alt: 'Tacos de desayuno con huevo, chorizo y salsa fresca', span: 'row-span-2' },
  { src: '/images/quesadilla.jpg', alt: 'Quesadilla dorada rellena de queso derretido y carne', span: '' },
  { src: '/images/menudo.jpg', alt: 'Menudo tradicional servido los fines de semana', span: '' },
];
...
export default function AboutPageEs() {
  ...
  return (
    <>
      <Navbar locale="es" currentPath="/es/about" />
      <main>
        {/* Hero */}
        <section className="relative flex h-[50vh] items-center justify-center overflow-hidden">
          <Image
            src="/images/tortillas.jpg"
            alt="Tortillas frescas hechas a mano siendo preparadas en Tortilleria El Rancherito"
            fill
                ...
                <div className="lg:w-2/5">
                  <div className="relative overflow-hidden rounded-lg">
                    <Image
                      ...
                      alt="Tamales frescos hechos a mano en Tortilleria El Rancherito"
                      width={600}
                      height={800}
              ...
              <div className="flex flex-col gap-12 lg:flex-row lg:items-center">
                ...
                <div className="lg:w-2/5">
                  <div className="relative overflow-hidden rounded-lg">
                    <Image
                      src="/images/tortillas.jpg"
                      alt="Tortillas siendo prensadas y cocinadas en el comal de nuestra tortilleria"
                      width={600}
                      height={400}
                      className="h-auto w-full object-cover"
                      loading="lazy"
                ...
                <div className="lg:w-2/5">
                  <div className="relative overflow-hidden rounded-lg">
                    <Image
                      ...
                      alt="Pollo ranchero y productos mexicanos auténticos disponibles en nuestra tienda"
                      width={600}
                      height={400}
                      className="h-auto w-full object-cover"
                      loading="lazy"
